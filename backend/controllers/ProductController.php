...
class ProductController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($model->save(false)) {
                yii::$app->session->addFlash('success','them moi thanh cong');
                return $this->redirect(['view', 'id' => $model->pro_id]);
            }else{
                yii::$app->session->addFlash('danger','them moi khong thanh cong');
        ...
        if ($model->load(Yii::$app->request->post())) {
           $model->image = UploadedFile::getInstance($model,'image');
            ...
            if ($model->save(false)) {
                ...
                yii::$app->session->addFlash('danger','update moi khong thanh cong');
                return $this->render('create', [
                'model' => $model,
            ]);
            }
